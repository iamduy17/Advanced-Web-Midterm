...
function Register() {
  ...
  const { isLoading, isError, error, mutate } = useMutation(postDataRegister, {
    onSuccess: (res) => {
  ...
  return (
    <div className="register__container">
      {isErrorAuth.isError && (
        <div className="alert alert-danger register__alert" role="alert">
          {isErrorAuth.message}
        </div>
      )}
      {isSuccess && (
      ...
      <div className="register__form-container">
        ...
        <form className="register__form">
          ...
          <button
            type="submit"
            className="register__submit mt-2 mb-2"
            onClick={submitUser}
